...
const page = () => {
  ...
  const dataa = useSelector((state) => state.counter);
  console.log("dataa", cartItems, cartTotalQuantity, cartTotalPrice);
  ...
  return (
    <div className="w-full lg:bg-gradient-to-tr from-slate-200 via-slate-50 to-orange-100 bg-white lg:py-16 py-2 min-h-screen ">
      {cartItems.length > 0 ? (
        <div className="container flex flex-col lg:flex-row  relative gap-12  ">
