  ...
  return (
    <main className="w-full  ">
      ...
      <div className="container flex justify-center">
        <div className=" lg:w-[600px] md:w-[600px] w-[350px] absolute lg:top-[150px] xl:top-[250px] md:top-[250px]   lg:right-32 top-40 lg:text-start text-center bg-[#cee0f3] p-16  rounded-2xl ">
